...
namespace ShareCircle.Data
{
    public static class DbInitializer
    {
        public static void Initialize(ShareCircleDbContext context)
        {
            ...
            {
            new() {ID_stroska=stroseki[0].ID,ID_dolznika=Uporabniki[0].Id,Znesek=0.67m,Strosek=stroseki[0],Dolznik=Uporabniki[0]},
            new() {ID_stroska=stroseki[0].ID,ID_dolznika=Uporabniki[1].Id,Znesek=0.67m,Strosek=stroseki[0],Dolznik=Uporabniki[1]},
            new() {ID_stroska=stroseki[0].ID,ID_dolznika=Uporabniki[2].Id,Znesek=0.67m,Strosek=stroseki[0],Dolznik=Uporabniki[2]},
            new() {ID_stroska=stroseki[0].ID,ID_dolznika=Uporabniki[3].Id,Znesek=0.67m,Strosek=stroseki[0],Dolznik=Uporabniki[3]},
            new() {ID_stroska=stroseki[0].ID,ID_dolznika=Uporabniki[8].Id,Znesek=0.66m,Strosek=stroseki[0],Dolznik=Uporabniki[8]},
            new() {ID_stroska=stroseki[0].ID,ID_dolznika=Uporabniki[9].Id,Znesek=0.66m,Strosek=stroseki[0],Dolznik=Uporabniki[9]},
            new() {ID_stroska=stroseki[1].ID,ID_dolznika=Uporabniki[0].Id,Znesek=1.34m,Strosek=stroseki[1],Dolznik=Uporabniki[0]},
            new() {ID_stroska=stroseki[1].ID,ID_dolznika=Uporabniki[1].Id,Znesek=1.34m,Strosek=stroseki[1],Dolznik=Uporabniki[1]},
            new() {ID_stroska=stroseki[1].ID,ID_dolznika=Uporabniki[2].Id,Znesek=1.33m,Strosek=stroseki[1],Dolznik=Uporabniki[2]},
            new() {ID_stroska=stroseki[1].ID,ID_dolznika=Uporabniki[8].Id,Znesek=1.33m,Strosek=stroseki[1],Dolznik=Uporabniki[8]},
            new() {ID_stroska=stroseki[1].ID,ID_dolznika=Uporabniki[9].Id,Znesek=1.33m,Strosek=stroseki[1],Dolznik=Uporabniki[9]},
            new() {ID_stroska=stroseki[1].ID,ID_dolznika=Uporabniki[3].Id,Znesek=1.33m,Strosek=stroseki[1],Dolznik=Uporabniki[3]},
